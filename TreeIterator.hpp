...
/*   Updated: 2022/07/10 01:50:14 by lkindere         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{		
	...
	public:
		...
		//																	Operators
		template <typename T>
		TreeIterator<pointer>&			operator=(const TreeIterator<T>& iter) { ptr_ = iter.base(); return (*this); }

		template <typename Iter>
		bool							operator==(const TreeIterator<Iter>& iter) const { return (ptr_ == iter.base()); }
		template <typename Iter>
		bool							operator!=(const TreeIterator<Iter>& iter) const { return (ptr_ != iter.base()); }
